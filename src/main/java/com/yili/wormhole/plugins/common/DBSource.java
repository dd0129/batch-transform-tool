...
//import com.dp.nebula.com.yili.wormhole.common.WormholeException;
...
public final class DBSource {
	...
	/**
	 * A synchronized static method which create {@link javax.sql.DataSource}.
	 *
	 * @param clazz
	...
	/**
	 * A synchronized static method which create {@link javax.sql.DataSource}. NOTE:
	...
	/**
	 * generate key to get {@link javax.sql.DataSource}
	 * 
